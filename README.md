...
1. Исходным материалом являются самооценки человека по **измерениям** — осям человеческих качеств
   («люблю тишину», «рано встаю», «читаю на ночь»), которые придумывает сообщество.
...
1. Измерения придумывает сообщество. Форма предложения нового измерения размещена на экране
   «Измерения»; предложение рассматривается автором сервиса.
