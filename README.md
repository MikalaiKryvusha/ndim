...
[![Framework](https://img.shields.io/badge/Framework-KAIF%202.7-7F52FF.svg)](https://github.com/MikalaiKryvusha/KAIF)
...
[KAIF](https://github.com/MikalaiKryvusha/KAIF) — здесь развёрнута версия **2.7 «Audited KAIF»**
(с 2026-09-18; версия и история обновлений — в маркере `.kaif/kaif.json`, проверка —
...
**2.7 "Audited KAIF"** (since 2026-09-18; the version and update history live in the
