...
[KAIF](https://github.com/MikalaiKryvusha/KAIF) — здесь развёрнута версия **2.8 «Noble KAIF»**
(с 2026-09-26; версия и история обновлений — в маркере `.kaif/kaif.json`, проверка —
...
**2.8 "Noble KAIF"** (since 2026-09-26; the version and update history live in the
