...
**Статус:** 🟡 лечение применено 2026-09-26 ≈08:00 по слову владельца (интервью №099, В1 = А: стейдж — 3 версии, бой — 10;
в чате: «*храним 10 последних выкатов, не больше. старые выкаты удаляем*»); место освобождено (замер — в интервью №099,
раздел «Исполнение»: стейдж 10,82 → 1,27 ГБ). ⏳ Закрытие — после живого выката стейджа `npm run deploy -- --stage` · **Тяжесть:** S1 — стейдж заперт, а без
