<!--
  ...
  24 вещи по правилу, №098 В2 и №100 В2); каждой попытке — своя случайная дюжина, второму человеку пары —
...
<article class="test">
  ...
  <div class="two">
    <!-- `data-live` — карточка ожила: звёзды живые. До него видно лицо пререндера с мёртвыми звёздами (приборы ждут этот знак). -->
    <section class="qcard" data-live={alive ? '' : undefined} aria-label={c.h1}>
      {#if !alive}
        <!--
