<script lang="ts">
   ...
   * 🆕 2026-09-25: слово `landing` вместо `1` — место входа гостя для аналитики (`ANALYTICS_ENTRIES`
   * в `funnel.ts`, `plans/105` Б2); профиль читает его и срезает из адреса вместе с параметром.
   */
  const DEMO_URL = '/profile?guest=landing';
