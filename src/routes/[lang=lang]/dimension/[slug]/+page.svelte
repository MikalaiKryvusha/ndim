    ...
    <p class="rate">
      {#if data.showStars}
        ...
        <span class="stars" aria-hidden="true">
          ...
          {#if stars.grey}<i class="zero">★</i>{/if}
        </span>
...
<style>
  ...
  /* Ноль — осознанная оценка «ноль», а не «золото». Он серый — ТЕМ ЖЕ токеном, каким серую
     звезду ноля рисует шкала ВВОДА оценок (`src/routes/dims/+page.svelte`, `.st.zero i`).
     Владелец сослался на неё дословно: «одна серая звезда, как в шкале оценок» (№044 В3). */
  .stars i.zero {
    color: var(--faint);
  }
