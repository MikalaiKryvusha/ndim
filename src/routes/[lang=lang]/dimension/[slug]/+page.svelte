  ...
  const T = {
    ru: {
      ...
      doorNoVotes: (t: string) =>
        `NDim Space Rating появляется с первым голосом. ` +
        `Оцените «${t}» и ещё несколько вещей, которые Вы любите, ` +
        `и Пространство покажет Вам людей, которые думают так же. ` +
        `Первым может стать Ваш.`,
      doorVoted: (t: string) =>
        `NDim Space Rating сложился из голосов, которые поставили люди Пространства. ` +
        `Оцените «${t}» и ещё несколько вещей, которые Вы любите, ` +
        `и Пространство покажет Вам людей, которые думают так же. ` +
    ...
    en: {
      ...
      /** Зеркало русской половины по СМЫСЛУ, а не построчный перевод (см. врезку там). */
      doorNoVotes: (t: string) =>
        `An NDim Space Rating starts with the first vote. ` +
        `Rate “${t}” and a few more things you love, ` +
        `and the Space will show you people who think the same way. ` +
        `Yours could be the first.`,
      doorVoted: (t: string) =>
        `This NDim Space Rating is built from votes cast by people in the Space. ` +
        `Rate “${t}” and a few more things you love, ` +
        `and the Space will show you people who think the same way. ` +
        `Your vote makes it sharper.`,
      place: 'Rank',
