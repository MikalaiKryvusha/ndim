 ...
 * тронут: включить его «чтобы заработали звёзды» значило бы вернуть бандл фреймворка и 10 222
 * файла `__data.json` на всю SEO-поверхность. Вместо этого дверь — «ванильный остров»:
