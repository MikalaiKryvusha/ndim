...
<div class="screen">
  ...
  <main class="body">
    ...
    <!-- ── Правая колонна: проект, версии ──
         Разбиение выбрано ЗАМЕРОМ, а не на глаз: «Документы» отданы левой колонне, иначе
         колонны расходятся 250 против 525px. Порядок при этом сохранён — на телефоне колонны
         идут одна за другой, и последовательность остаётся прежней. -->
