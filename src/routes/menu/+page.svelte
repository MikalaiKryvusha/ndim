...
<div class="screen">
  ...
  <main class="body">
    ...
    <!--
      ⚠️ ЛЕВАЯ КОЛОННА НАЧИНАЕТСЯ ВЫШЕ — с манифеста (слово владельца 2026-07-31: «Меню нужно
      привести к двум колонкам»). Раньше манифест был ТРЕТЬИМ, самостоятельным столбцом, и
      экран шёл в три колонки; теперь он живёт внутри левой, а колонн ровно две — как на
      «Пространстве» и «Профиле».

      Почему манифест положен именно СЮДА, а не в правую: колонны надо балансировать руками
      (браузер этого не делает). Слева манифест + «Вид» + «Поделиться», справа «Документы» +
      «Проект» + «Версии» — по замеру это самая ровная из раскладок, сохраняющих порядок
      (порядок важен: на телефоне колонны растворяются, и он остаётся прежним).
    -->
