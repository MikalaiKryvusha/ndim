<script lang="ts">
   ...
   *
   * Эта фаза — только ДОМ: адрес, оболочка, граница доступа. Менеджер измерений (стопка
   * кандидатов по утверждённому макету V1 `plans/32`) въезжает в фазе 4 — здесь для него
   ...
   * механическая — строка ведёт в живой Менеджер измерений, и её отсутствие уронило бы страж.
   */
</script>
  ...
  <div class="screen">
    ...
    <main class="body">
      ...
      <!--
        ...
        Сегодня инструмент один и он ещё не построен (Менеджер измерений — фаза 4 эпика,
      ...
      -->
      <!--
        🆕 2026-08-17: инструмент стал ДВЕРЬЮ — Менеджер измерений построен (`plans/44` фаза 4).
...
<style>
   ...
   * только на Менеджер измерений: серым здесь блёкнут и подписи инструментов дома панели.
