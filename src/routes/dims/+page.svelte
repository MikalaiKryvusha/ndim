<script lang="ts">
  ...
  async function cancelRating(): Promise<void> {
     ...
     * карточка стояла бы обрезанной 246px до смены вкладки. Если улёт уже завершился и узел
     * умер — селектор вернёт свежий узел без стилей (или null), очистка безвредна.
     */
