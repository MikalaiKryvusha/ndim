<script lang="ts">
  ...
  const t = {
     ...
     * Место разрыва он уточнил тем же днём, увидев кадры на 390 (интервью №076, В1 = В):
     * «делаем "гостем без регистрации" — одной второй строкой». До этого разрыв стоял перед
     * «без регистрации», и на телефоне слово «гостем» оставалось одно на строке.
     ...
     */
    guest: {
      ru: 'Смотреть Пространство NDim Space\nгостем без регистрации',
      en: 'Explore NDim Space\nas a guest without signing up',
    },
