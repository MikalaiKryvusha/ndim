...
export interface PreservedFields {
  ...
  /**
   * 🔴 Технические теги (`plans/58`). Их ставит РАЗМЕТКА, а не форма правки: человек в Менеджере измерений
 ...
 *
 * Раньше этот набор жил россыпью в Менеджере измерений, и цена такого расположения уже известна:
 ...
 *
 * 🔑 Почему здесь, а не в одобрении кандидата. В Менеджере измерений ДВЕ двери к созданию: одобрение
