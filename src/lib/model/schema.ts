 ...
 * раскрытой связи (`bugs/46`, кадр app-16). Кладёт его вычислитель: `points/{uid}` чужого
 * человека зрителю по правилам недоступен, а у вычислителя число уже загружено.
 *
 ...
 *
 * Живёт здесь, а не в вычислителе, потому что число видит ЧЕЛОВЕК: профиль пишет
