 ...
 * правила (см. шапку модуля). Отсюда их берут оба потребителя: комната измерений при рождении
...
export const TECH_TAG = {
  ...
  UNCHECKED: 'unchecked',
  /** Одобрено владельцем: запись прошла через его руки в комнате измерений (интервью №044, В4 = A). */
