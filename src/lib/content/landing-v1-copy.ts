 ...
 * `[AI]` ПРАВКА ПРАВДЫ 2026-09-26 (`b878d9b`, суд V4 — находка 2 и её близнец; НА ВЫЧИТКУ владельцу, эта строка
 *   утверждена им дословно в №096 В16 = А):
 *   · ответ FAQ «Как пройти тест на совместимость с другом?», RU и EN — прежний называл «фильмы, сериалы, игры и
 *     привычки» (в пуле теста №098 практик нет) и «Вы и друг нажмёте «Сравнить ответы»» (в V4 первый жмёт
 *     «Проверить»). Оставлено «Друг оценит эти 12 вещей» — второй оценивает вещи первого, их может быть больше 12.
