 ...
 * сенситив темы, оставим добрые и одобряемые*». Состав списка — `[AI]` по мандату этого слова: сенситивные практики
 * из верха каталога по голосам — «Секс» (11), «Употребление алкогольных напитков» (7), «Курение» (6), «Мастурбация» (3,
 * стоит сразу под четвёркой теста — без неё юнит сам потребовал бы её при первом сдвиге голосов; находка суда 2026-09-25). Юнит
 ...
 */
export const SENSITIVE_PRACTICES: readonly string[] = ['BDsOxBipIv04OwFlWuRv', 'FBvganYvQcCGOQCrR7ky', 'itpS5fEWNcPCd4P0An5W', 'VAQJHkVIeOCC3Ft5223h'];
