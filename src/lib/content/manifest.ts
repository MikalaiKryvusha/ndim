...
export const MANIFEST = {
  // Заголовок задан владельцем дословно (чат 2026-07-27): «в меню „Зачем существует
  // Пространство NDim“ — это заменить просто на Манифест Ndim Space». Написание бренда
  // приведено к каноническому `NDim Space` («Словарь продукта»).
  title: {
    ru: 'Манифест NDim Space',
    en: 'NDim Space Manifest',
  },
  paragraphs: {
    ru: [
