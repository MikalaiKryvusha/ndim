...
/**
 * Сама инлайн-строка счёта прихода на главной живёт в `root-landing-view.ts`: она статически
 * тянет список роботов из `@posthog/core`, а этот модуль обязан оставаться лёгким чанком
 * (`EXP-0028`). Здесь — только константы, которые строка берёт значениями на сборке.
 */
