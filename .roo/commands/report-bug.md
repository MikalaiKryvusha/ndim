...
4. **Доставь по режиму отслеживания:** `origin` — запусти машинерию, тем же движением, что и
   заведение, и ПРЕЖДЕ работы, в которой дефект найден:
...
> `report` — ровно то, что предлагал наш тикет, — и шаг 4 теперь совпадает с каноном.
