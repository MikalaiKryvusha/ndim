...
> ⚠️ **Расхождение с каноном 2.3, названное честно (обновление 2026-08-28).** Шаблон 2.3 переписал
> шаг 4: по стоячему правилу владельца KAIF (issue #15 истока) сигнал о дефекте KAIF доставляется в
> исток за подписью агента, без очереди к человеку; гейт `/owner-reviews` остаётся для ЧУЖИХ
> репозиториев и публикаций от имени владельца. Локальный текст шага 4 сознательно оставлен
> СТРОЖЕ канона (перенос заблокирован классификатором агентской системы при обновлении); дословная
> дельта шаблона — в `.kaif/backup-2.2-2.3` и в отчёте `reports/KAIF_UPDATES/…_2.3_…`. Работать
> строже канона законно; при следующем касании файла — предъявить владельцу.
