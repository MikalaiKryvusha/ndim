...
5. **Как выглядит обычный рабочий процесс.** Короткий пример: *«`/resume`, чтобы начать → я работаю и
   ...
   `/pause`, чтобы прерваться (чат продолжится позже), или `/end-chat`, чтобы закрыть чат с
   передачей эстафеты».* Отметь роль человека (визионер: `GOAL.md`, идеи, ответы на интервью) против
