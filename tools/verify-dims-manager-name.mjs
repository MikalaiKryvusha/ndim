 ...
 * Измерений!*»
 *
 * ИМЯ-ОК: запрещённое имя названо как ПРЕДШЕСТВЕННИК класса — без него не объяснить, откуда
 * взят порядок лечения; это разбор чужого случая, а не наше именование компонента.
 *
