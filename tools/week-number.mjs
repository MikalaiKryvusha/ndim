 ...
 *
 * ПОЯС ОКНА — московское время, +03:00 (`bugs/NEW_DONE_week_number_window_labelled_utc_is_moscow.md`). Неделя идёт с
 ...
 *
 * [TESTED: 2026-09-25 16:52 · пояс окна · ручной прогон на бою — прогон МЕНЕДЖЕРА из главной копии (ключ чтения PostHog
 *  только там), голова d6bdf3e: недели 2026-09-21 и 2026-09-14 ДО и ПОСЛЕ правки одним заходом — пять чисел равны
 *  (8 · 0 · 0 · 0 · 0 и 160 · 9 · 3 · 6 · 0), HogQL подтвердил начало окна 2026-09-20 21:00 UTC; первый заход 16:50 на
 *  06726b0 вскрыл ложный красный контроля (сверка строк при DateTime64 «.000000») — вылечен; отчёт
