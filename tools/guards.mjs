...
const GUARDS = [
  ...
  {
    name: 'граница ролевого .env: боевых ключей в копии роли нет',
    why: 'замечание З1 вердикта №6 + EXP-0194 «страж вне ворот не запускают»: страж дешёвый (ни сети, ни стенда, ни сборки) и в главной копии молчит по устройству. Класс оплачен EXP-0216 — копирование .env целиком раздаёт роли боевой ключ Firestore, который ей не положен',
    argv: ['tools/verify-role-env.mjs'],
  },
  {
