 ...
 *
 * [TESTED: 2026-09-26 16:26 · ручной функциональный прогон 16/16 на дереве проекта — отказ «ссылка наружу» до генератора,
 *  показ, радиокнопка снимается повторным нажатием, ответы по одному, ожидатель, сервер умер → ответ на компьютере → забран;
 *  qa/reports/2026-09-26_shipped-review-page.md. Окно Edge и голос Евгения у владельца подтверждены его словом (интервью №106,
 *  В1 = А, 16:22) — на редакции ДО починки радиокнопки]
 */
