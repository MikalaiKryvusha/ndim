 ...
 * [TESTED: 2026-08-29, прогон МЕНЕДЖЕРА из главной копии] СЕТЕВОЙ ПУТЬ `--live` исполнен на
 * живом бою: снимок от 2026-08-29 (0 дн.), витрина людей 95 · измерений 5144 · оценок 4071 ·
 * связей 2368, разница по всем ЧЕТЫРЁМ полям 0, вердикт «сходится, снимок свежий».
 * ⚠️ Оговорка контура обязательна: числа сняты против снимка ГЛАВНОЙ КОПИИ, а не этой ветки —
 * здесь снимок старше и даёт другие `dims`. Прогон доказывает, что чтение боя работает и что
 * приговор на сошедшихся числах молчит; он НЕ доказывает поведения на расхождении — это
 * доказано самотестом (случай `bugs/170`: 5122 против 5121 → ЗАВЫШЕНИЕ).
