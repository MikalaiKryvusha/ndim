 ...
 * «2.5 «Experienced KAIF»» (её только что поправило обновление), английская — «2.2 "Yolden KAIF"», KAIF-VERSION-OK: история стража.
 ...
 * PROVED-AGAINST: боевой дрейф, найденный до написания стража (en «2.2 "Yolden KAIF"» и бейдж KAIF-VERSION-OK: история стража.
