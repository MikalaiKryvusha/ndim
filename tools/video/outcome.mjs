 ...
 *  контроль (landing_view без фильтра метки) НЕ ПРОШЁЛ — сеть до eu.posthog.com рвала соединение «other side closed»;
 *  прогнать контроль до первого настоящего исхода]`
 *
