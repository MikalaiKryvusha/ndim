...
export const КОМПОНЕНТЫ = [
  { id: 'brand', имя: 'Знак N-сети', слой: 'Бренд', адрес: '/profile?as=none', селектор: '.signin-screen .mark' },
  { id: 'appbar', имя: 'Шапка приложения', слой: 'Каркас', адрес: '/profile', селектор: 'header.bar' },
  { id: 'bottomnav', имя: 'Нижняя панель', слой: 'Каркас', адрес: '/profile', селектор: 'nav.bnav' },
  { id: 'siderail', имя: 'Рельс навигации', слой: 'Каркас', адрес: '/profile', селектор: 'nav.rail', ширина: 1440 },
  { id: 'publicbar', имя: 'Шапка публичной страницы', слой: 'Каркас', адрес: '/ru/dimension/donnie-darko-1hqyrh7o', селектор: 'header.bar' },
  { id: 'cta-primary', имя: 'Кнопка основная', слой: 'Действия', адрес: '/profile?as=none', селектор: '.signin-screen .d.primary' },
  { id: 'cta-ghost', имя: 'Кнопка призрачная', слой: 'Действия', адрес: '/profile?as=none', селектор: '.signin-screen .d.ghost' },
  { id: 'cta-guest', имя: 'Кнопка гостевой двери', слой: 'Действия', адрес: '/profile?as=none', селектор: '[data-door="guest"]' },
  { id: 'input', имя: 'Поле ввода', слой: 'Действия', адрес: '/profile?as=none', селектор: '.signin-screen .inp', шаги: [{ клик: '.signin-screen .d.ghost' }] },
  { id: 'lang-theme', имя: 'Переключатели языка и темы', слой: 'Действия', адрес: '/profile?as=none', селектор: '.signin-screen .ctl' },
  { id: 'guest-badge', имя: 'Признак гостя', слой: 'Состояния', адрес: '/profile?as=guest', селектор: 'header.bar .badge' },
  { id: 'guest-note', имя: 'Карточка гостя', слой: 'Состояния', адрес: '/profile?guest=1', селектор: 'xpath=//ul[contains(@class,"guest-facts")]/..', пауза: 6000 },
  { id: 'catalog-card', имя: 'Карточка объекта каталога', слой: 'Каталог', адрес: '/ru/catalog/movie', селектор: '.cat-list li, .hub-list li, li' },
  { id: 'root-strip', имя: 'Полоса каталога на главной', слой: 'Каталог', адрес: '/', селектор: 'main .cat-list' },
  { id: 'showcase', имя: 'Витрина чисел', слой: 'Данные', адрес: '/', селектор: 'main .showcase' },
  { id: 'pitch', имя: 'Мультиязычная карточка', слой: 'Данные', адрес: '/', селектор: 'main .pitch' },
];
