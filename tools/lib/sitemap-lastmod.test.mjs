...
test('🔴 список компонентов служебного класса ЗАМКНУТ: новый компонент с тем же классом краснеет здесь', () => {
  ...
  // Граница (закрывающий суд 2026-09-26): компонент, вычеркнутый из SERVICE вместе с переименованием своего класса,
  // выпадает из обеих сторон сверки — это не ловится (мутант MJ-2 суда lastmod3 остаётся зелёным).
