 ...
 *
 * 🔴 ЧЕСТНАЯ ГРАНИЦА, ОПЛАЧЕННАЯ ПОЛЕМ: прибор судит НАЛИЧИЕ довода, а не его КАЧЕСТВО.
 * Первая же пачка закрытий это показала — 13 документов из 14 закрыты доводом «шапка документа
 * объявляет лечение дословно», то есть ссылкой документа на самого себя. Круг: документ закрыт
 * потому, что документ так сказал. Долг заведён на автора этой пачки — `bugs/222`, там же замер
 * и критерии; лечение того же рода, что у опт-аута стража спящих объявлений (вердикт №23):
 * довод обязан нести ЯКОРЬ — файл, прогон, коммит, номер урока, — то, что читатель может открыть.
 *
