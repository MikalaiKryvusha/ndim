...
9. 🔴 **МУТИРУЯ ПРИБОР, КОТОРЫЙ ЧТО-ТО ДЕЛАЕТ С МИРОМ, ОБЕЗВРЕЖИВАЙ ЕГО В ИСХОДНИКЕ МУТАНТА —
   ...
   *(Правило выведено dev-1 смены 11 на собственной ошибке. 🔑 Его цену подтвердил ЧУЖОЙ случай в
   ...
   правила пошла бы подбирать безопасный `argv` тем же путём. ⚠️ Сам вердикт №28 на момент
   внесения строки живёт в ветке QA и в стволе не лежит — случай назван по источнику, а не
   наблюдался автором правила; форма — по правилу 8 выше.)*
