...
const RUNS = [
  ...
  },
  {
    ...
    flag: '--portion2',
    // Без Г2 чистый браузер входит адресом сразу, а свой гость второго браузера — привязкой: исход тот же, экрана нет.
    expectRed: ['ВС-10 экран Г2 и «пока вопрос открыт — сессии нет»', 'ВС-10 три клетки', 'ВС-11 шаг «идёт вход» (вход прошёл раньше)',
      'ВС-12 экран Г2 своему гостю и шаг «идёт вход»', 'ВС-15'],
    expectGreen: ['ВС-10 «ничего не вылезает»', 'ВС-11 аккаунт адреса · оценок 0 · гость контекста 1 цел', 'ВС-12 тот же uid и оценки целы',
